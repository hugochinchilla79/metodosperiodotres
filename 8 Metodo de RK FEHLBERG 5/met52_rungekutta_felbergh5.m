...
%K6 = h*f(ti + h/2 , wi + 8K1/27 + 2K2 - 3544K3/2565 + 1859K4/4104 - 11K5/40)
%wnumero = wi + (16/135) K1 + (6656/12825) K3 + (28561/56430) K4 - (9/50) K5 + (2/55) K6)
...
for j=a:h:(b-h)
   ...
   fprintf('\n');
   fprintf('- K3 = %1.15f * f(%1.15f + %1.15f , w%1.15f + %1.15f + %1.15f)',h,t(i),((3/8)*h),i-1,(3*(double(k1))/32),(9*(double(k2))/32));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- K6 = %1.15f * f(%1.15f + %1.15f , w%1.0f + %1.15f + %1.15f - %1.15f + %1.15f - %1.15f)',h,t(i),h,i-1,(8*(double(k1))/27),(2*(double(k2))),(3544*(double(k3))/2565),(1859*(double(k3))/4104),(11*(double(k3))/40));
   fprintf('\n');
   ...
   fprintf('\n');
   fprintf('- w%1.0f = w%1.0f + %1.15f + %1.15f + %1.15f - %1.15f + %1.15f',i,i-1,(16/135)*double(k1),(6656/12825)*double(k3),(28561/56430)*double(k4),(9/50)*double(k5),(2/55)*double(k6))
   fprintf('\n');
